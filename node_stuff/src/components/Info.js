...
function Info() {
    ...
    const diseases = [
        ...
        },
        {
            ...
            description:
                "Squamous Cell Carcinoma (SCC) is a type of skin cancer that originates in the squamous cells, which are thin, flat cells found in the outer layer of the skin (epidermis). It typically appears as a firm, red nodule or a flat lesion with a scaly crust. SCC can develop on sun-exposed areas of the body but may also occur in areas not regularly exposed to sunlight. It has the potential to metastasize (spread) to other parts of the body if not treated early. Risk factors include prolonged sun exposure, fair skin, older age, and immunosuppression. Treatment often involves surgical removal, with a high cure rate if detected and treated early. Regular skin examinations and sun protection are key for prevention.",
        },
